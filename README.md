# sanity-gatsby-portfolio-personal
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/l3lc7iv9/settings/api) and create a token with read rights.
